      ...
      <div className="p-8 pt-0">
          ...
          <div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
            ...
            <div className="flex-1 flex flex-col ">
              <header className="mb-0.5 leading-5  flex items-center">
                ...
                <div className="ml-1 flex items-center">@X · 17m</div>
              </header>
        ...
        <div className="grid gap-3">
          ...
          <section>
            ...
            <div className="bg-[color:var(--background-secondary)] py-1 rounded-2xl  flex justify-around items-center">
              {colors.map((c, index) => (
                <button
                  key={index}
                  onClick={() => {
          ...
          <section>
            ...
            <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
              <button
                ...
                className={classNames(
                  "h-[62px] px-5 bg-white text-[#0f1419] border font-bold border-white/10 rounded group flex items-center gap-1.5",
                  {
              ...
              <button
                ...
                className={classNames(
                  "h-[62px] pr-5 pl-2 bg-black text-[#f7f9f9] border font-bold border-white/10 rounded group flex items-center gap-1.5",
                  {
                    "!border-[color:var(--color-primary)] !border-2":
