    ...
    >
      <label className="h-[43px] rounded-full bg-[color:var(--background-third)] w-full relative group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[#1d9bf0]">
        ...
        <input
          type="text"
          placeholder="Search"
          className="w-full h-full bg-transparent rounded-full pl-[56px] text-[15px]"
          value={query}
      ...
      {focus && (
        <div className="absolute w-[350px] top-full -left-px  bg-color:var(--background-primary) shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
