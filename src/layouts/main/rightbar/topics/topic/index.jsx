  ...
  return (
    ...
    >
      ...
      <Popover className="absolute top-1.5 right-2">
        <Popover.Button className="outline-none w-[34.75px] h-[34.75px] rounded-full text-[#71767b] flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0] transition-colors">
        ...
        <Popover.Panel className="w-[384px] rounded-xl grid absolute top-2 overflow-hidden right-0 bg-black shadow-box z-[1]">
          <button
            type="button"
            className="hover:bg-white/[0.05] transition-colors text-left py-3 px-4 flex items-center gap-3 text-[15px] leading-5 font-bold text-[#e7e9ea]"
          >
            <svg viewBox="0 0 24 24" width={18.75}>
              <path
                fill="currentColor"
