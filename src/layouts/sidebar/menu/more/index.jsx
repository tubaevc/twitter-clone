...
export default function More() {
  return (
    <Popover className="relative">
      <Popover.Button className="py-[0.188rem] block group outline-none">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)]  shadow-box rounded-xl">
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]]">
          ...
          <div className="pr-4 text-xl font-bold">Bookmarks</div>
        </button>
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]]">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={24} height={24}>
          ...
          <div className="pr-4 text-xl font-bold">Connect</div>
        </button>
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]]">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={24} height={24}>
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px] w-full flex items-center px-4 justify-between font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
                Creator Studio
                <svg
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px] flex items-center px-4  w-full justify-between font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
                Setting and Support
                <svg
                  className={classNames({
                    "rotate-180 text-[text-[color:var(--color-primary)]": open,
                  })}
                  viewBox="0 0 24 24"
                  width={18.75}
                  height={18.75}
