    ...
    <Popover className="relative">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px] w-full flex items-center px-4 justify-between font-bold hover:bg-[#eff3f41a] transition-colors">
                Creator Studio
                <svg
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px] flex items-center px-4  w-full justify-between font-bold hover:bg-[#eff3f41a] transition-colors">
                Setting and Support
                <svg
                  className={classNames({
                    "rotate-180 text-[#1d9bf0]": open,
